    ...
    tiers: [
      {
        ...
        monthly: 0,
        annual: 0,
        description: "Try SignalForge AI with 3 free trades.",
        features: [
          "3 free trades",
          "AI-powered CALL / PUT signals",
      ...
      },
      {
        ...
        monthly: 39.99,
        annual: 399.90,
        description: "For active binary-options traders who want more signals.",
        features: [
          "20 trades per day",
          "AI-powered CALL / PUT signals",
          "Real-time market analysis",
      ...
      },
      {
        ...
        monthly: 79.99,
        annual: 799.90,
        description: "For serious traders who want unlimited SignalForge AI access.",
        features: [
          "Unlimited trades",
          "AI-powered CALL / PUT signals",
          "Real-time market analysis",
