...
`,document.body.appendChild(Y),Y.querySelector(`#closePayment`).addEventListener(`click`,()=>{Y.remove(),Y=null}),Q(),ce(),le(t)}async function Q(){let e=Y.querySelector(`#subscriptionPlans`);try{let t=await q();if(e.innerHTML=``,!Array.isArray(t.plans)||t.plans.length===0){e.innerHTML=`
                <p class="auth-error">
